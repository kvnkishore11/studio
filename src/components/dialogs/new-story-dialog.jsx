// src/components/dialogs/new-story-dialog.jsx
"use client";
 ...
 * @returns {JSX.Element} The new story dialog component
 */
export function NewStoryDialog() {
  ...
  /**
   * Handles story generation using AI
   */
  ...
  /**
   * Handles story regeneration using AI
   */
  ...
  /**
   * Handles saving the generated story
   */
  const handleSave = () => {
    if (!currentGeneratedStory) return;
    const storyToSave = {
  ...
  /**
   * Handles editing the input form
   */
